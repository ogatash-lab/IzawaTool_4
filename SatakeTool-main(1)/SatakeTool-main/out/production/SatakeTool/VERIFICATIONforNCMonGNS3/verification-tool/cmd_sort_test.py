...
def sort_cmd_cisco3725(all_file_num):
    ...
    filename_cmd = 'VERIFICATIONforNCMonGNS3/verification-tool/cmd_node/cmd_kiki/'
    for i in range(all_file_num):
        filename = filename_cmd + "Cf" + str(i + 1)
...
for i in range(5, 7):
    ...
    while True:
        ...
        if switch_list[num][1] > switch_list[num + 1][1]:
            switch_list[num], switch_list[num + 1] = switch_list[num + 1], switch_list[num]
