...
time_count.count_start(time_filename)
...
with open(yaml_file_root + yaml_file_name) as file:
...
# len(yml) - 1
# 障害発生前
pcap_analysis.l2_pcap(project_ID, all_link_list, vpcs_name_ip_list, yml[0], vpcs_name_ID_list, kiki_name_ID_list, yaml_file_name_test)

for i in range(3):
    # 障害発生後
    pcap_analysis.l2_pcap(project_ID, all_link_list, vpcs_name_ip_list, yml[i + 1], vpcs_name_ID_list, kiki_name_ID_list, yaml_file_name_test)

time_count.count_stop(time_filename)
